<?php
    ...
    <div class="main-content container">
        <form>
            <div>
                <thead>Contact Details</thead><btr></br><br>
            ...
            <div>
                <label for="product_info">Product Information</label><br><br>
                <label for="product_description">Product Description</label>
                <textarea id="product_description" name="product_description" placeholder="Product Information"></textarea><br><br>
            </div>
    
            <div>
                <label for="makel">Make</label>
                ...
                <label for="invoice">Upload Proof of Purchase</label><br>
                <input type="file" id="invoice" name="invoice"><br><br>
            </div>
    
            <div>
    
                <label for="product_img">Upload Images of Product</label><br>
