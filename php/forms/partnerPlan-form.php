<?php
    ...
    <div class="main-content container">
        <form>
            ...
            <h2 class="text-success">Employment Details</h2><br>
            <div class="form-row">
                <div class="col">
            ...
            <div class="form-row">
                <div class="col">
                    <label for="address1">Street Address Line 1</label><br>
                    <input class=" w-100" type="text" id="work_address1" name="work_address1" placeholder="Stresst Address Line 1" value=""><br><br>
                </div>
    
                <div class="col">
                    <label for="address2">Street Address Line 2</label><br>
                    <input class="w-100" type="text" id="work_address2" name="work_address2" placeholder="Stresst Address Line 2" value=""><br><br>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="col">
                    <label for="draw_Date">Preferred Draw Date</label>
                    <input type="date" id="draw_Date" name="draw_Date"><br><br>
                </div>
            ...
            <div class="form-row">
                <div class="col">
                    ...
                    <input type="text" id="bank" name="bank" value=""><br><br>
                </div>
    
                <div class="col">
                    <label for="acc_num">Account Number</label>
                    <input type="text" id="acc_num" name="acc_num" value=""><br><br>
                </div>
                <div class="col"></div>
                <div class="col"></div>
            </div>
