<?php
    ...
    <h2 class="text-success">Contact Details</h2>
    <div class="form-row">
        ...
        <div class="col">
            <label for="other_number"> Other Number</label><br>
    ...
    <h2 class="text-success">Emergency Contact</h2>
    <div class="form-row">
        <div class="col">
            <label for="emergency_contact_fname">First name:</label><br>
            <input type="text" id="emergency_contact_fname" name="emergency_contact_fname" placeholder="First Name" value=""><br><br>
        </div>

        <div class="col">
            <label for="emergency_contact_mname">Middle name:</label><br>
            <input type="text" id="emergency_contact_mname" name="e_mname" placeholder="Middle Name" value=""><br><br>
        </div>

        <div class="col">
            <label for="emergency_contact_lname">Last name:</label><br>
            <input type="text" id="emergency_contact_lname" name="emergency_contact_lname" placeholder="Last Name" value=""><br><br>
        </div>

        <div class="col">
            <label for="emergency_contact_mobile_number">Mobile Number</label><br>
            <input type="text" id="emergency_contact_mobile_number" name="emergency_contact_mobile_number" placeholder="Mobile Number" value=""><br><br>
        </div>
    </div>
    <div class="form-row">
        <div class="col">
            <label for="emergency_contact_home_number">Home Number</label><br>
            <input type="text" id="emergency_contact_home_number" name="emergency_contact_home_number" placeholder="Home Number" value=""><br><br>
        </div>

        <div class="col">
            <label for="emergency_contact_business_number"> Business Number</label><br>
            <input type="text" id="emergency_contact_business_number" name="emergency_contact_business_number" placeholder="Business Number" value=""><br><br>
        </div>

        <div class="col">
            <label for="emergency_contact_other_number"> Other Number</label><br>
            <input type="text" id="emergency_contact_other_number" name="emergency_contact_other_number" placeholder="Other Number" value=""><br><br>
        </div>

        <div class="col">
            <label for="emergency_contact_email"> Email Address</label><br>
    ...
    <div class="text-center">
        <button id="contactDetailsSubmit" class="btn btn-success" type="button">Next</button>
