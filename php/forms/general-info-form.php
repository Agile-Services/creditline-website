        ...
        <form action="#">
            ...
            <div class="form-row">
                ...
                <div class="col m-3">
                    ...
                    <input class="form-control" type="text" id="fname" name="fname" placeholder="First Name" value=""><br><br>
                </div>
    
                <div class="col m-3">
                    <label for="mname">Middle name:</label><br>
                    <input class="form-control" type="text" id="mname" name="mname" placeholder="Middle Name" value=""><br><br>
                </div>
    
                <div class="col m-3">
                    <label for="lname">Last name:</label><br>
                    <input class="form-control" type="text" id="lname" name="lname" placeholder="Last Name" value=""><br><br>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="col m-3">
                    ...
                    <input class="form-control" type="date" id="dob" name="dob" placeholder="DD/MM/YYYY" value=""><br><br>
                </div>
    
                <div class="col m-3">
                    <label for="mname">Place of Birth:</label><br>
                    <input class="form-control" type="text" id="pob" name="pob" placeholder="Place of Birth" value=""><br><br>
                </div>
            ...
            <div class="form-row">
                <div class="col m-3">
                    ...
                    <input class="form-control" type="text" id="mothers_maiden" name="mothers_maiden" placeholder="Mother's Maiden Name" value=""><br><br>
                </div>
    
                <div class="col m-3">
                    <label for="dependents">Number of Dependents:</label><br>
                    <input class="form-control" type="number" id="dependents" name="dependents" placeholder="Number of Dependents" value=""><br><br>
                </div>
