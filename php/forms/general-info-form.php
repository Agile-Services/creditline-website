<?php
    ...
    <form action="#">
        ...
        <div>
            ...
            <input list="gender" placeholder="Male">
                <datalist id="gender">
            ...
            <input type="date" id="dob" name="dob" placeholder="DD/MM/YYYY" value=""><br><br>

            <label for="mname">Place of Birth:</label><br>
            <input type="text" id="pob" name="pob" placeholder="Place of Birth" value=""><br><br>
