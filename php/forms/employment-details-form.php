<?php
    ...
    <form>
        ...
        <div>
            ...
            <label for="vehicle1">Employed</label><br>
            <input type="checkbox" id="part-Time" name="part-Time" value="Part-Time">
            <label for="vehicle2">Part-Time</label><br>
            <input type="checkbox" id="self-employed" name="self-employed" value="Self-Employed">
            <label for="vehicle3">Self-Employed</label><br><br>

        </div>

        <div>
            
            <label for="emergency_contact_sig">Signature</label><br><br>
