    ...
    <form id="emp_form">
        ...
        <div class="form-row">
            <div class="col">
                ...
                <input type="text" class='formVal' id="business_name" name="business_name" placeholder="Name of Business" value=""><br><br>
            </div>

            <div class="col">
                <label for="date_established">Date Established</label><br>
                <input type="date" class='formVal' id="date_established" name="date_established" placeholder="DD/MM/YYYY" value=""><br><br>
        ...
        <div class="form-row">
                <div class="col custom-file">
                    <label class="custom-file-label" for="cert">Upload Business Certificate</label><br>
                    <input class="custom-file-input" type="file" id="cert" name="cert" onchange="
        ...
        <div class="form-row">
            <div class="col custom-file">
                <label class="custom-file-label" for="income">Upload Income Statement</label><br>
                <input class="custom-file-input" type="file" id="income" name="income" onchange="
                var file = this.files[0];  
                var filename = file.name;
                var label = document.querySelector(`[for='${this.id}']`);
                label.innerHTML = filename"
